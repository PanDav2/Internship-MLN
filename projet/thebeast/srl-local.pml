...
// phrasePosTag(p,pT) add [hasPhrase(p)]*w_sf3(pT);
//sf4
...
//weight w_sf5: DepTag x Relation -> Double;
//sf5
//factor : for Phrase p1, Phrase p2, DepTag dT, Resource r1, Resource r2, Relation rr
//	if phraseDepTag(p1,p2,dT) & hasResource(p1,r1) & hasResource(p2,r2) & !hasMeanWord(p1,p2) add [hasRelation(r1,r2,rr)]*w_sf5(dT,rr);

//sf6
//factor : for Phrase p0, Phrase p2, DepTag dT, Resource r1, Resource r2, Relation rr
